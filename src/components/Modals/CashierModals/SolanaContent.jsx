    ...
    <StyledBitcoinContent>
      <h1 class="title-actions">
        ...
        <img
          ...
          alt=""
        />
        Deposit Solana<div class="underline-text">View Transactions</div>
      </h1>

      <div class="qr-code-container">
        <div class={`flex ${isMobileScreen ? "flex-col" : ""}`}>
          <div>
            <div class="info-text">
              Send the amount of Solana of your choice to the following address
            ...
            <div class="warning-text">
              ...
              Only deposit over the SOL network. Do not use BNB or BSC networks
            </div>
            <div class="warning-text">
              <svg
                width="21"
          ...
          <img
            class="qr-code"
            style={{ marginLeft: isMobileScreen ? "0" : "32px" }}
        ...
        <div class="question-text">
          Missing SOL deposits? <span>Request deposit address sweep</span>
        </div>
      </div>
      ...
      <div class="exchange-rate-container">
        ...
        >
          The value of SOL may change between now and the time we receive your
          payment
        </div>
      </div>

      <div class="buy-crypto-container">
        <span>Don't have any Solana?</span>
