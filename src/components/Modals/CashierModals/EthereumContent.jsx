    ...
    <StyledBitcoinContent>
      <h1 class="title-actions">
        ...
        <img
          ...
          alt=""
        />
        Deposit ETHEREUM<div class="underline-text">View Transactions</div>
      </h1>
      ...
      <div class="qr-code-container">
        ...
        >
          Your personal Ethereum deposit address
        </label>
        ...
        <div class="question-text">
          ...
          <span>Request deposit address sweep</span>
        </div>
        <div class="question-text">
      ...
      <div class="exchange-rate-container">
        ...
        >
          The value of ETH may change between now and the time we receive your
          payment
        </div>
      </div>

      <div class="buy-crypto-container">
        <span>Don't have any Ethereum?</span>
...
export default EthereumContent;
