...
const RollbitContent = ({ handleBack }) => {
    ...
    <StyledBitcoinContent>
      <h1 class="title-actions">
        ...
        <img
          ...
          alt=""
        />
        Deposit Bitcoin<div class="underline-text">View Transactions</div>
      </h1>
      ...
      <div class="exchange-rate-container">
        ...
        >
          The value of BTC may change between now and the time we receive your
          payment
        </div>
      </div>
      <div class="buy-crypto-container">
        <span>Don't have any Bitcoin?</span>
