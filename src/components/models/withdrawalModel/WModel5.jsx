...
const WModel5 = () => {
    return (
        ...
        <div>
            ...
            <div style={{ width: "725px", height: "378px", margin: "40px 40px", borderRadius: "8px", background: "rgba(203, 215, 255, 0.03)" }}>
                <div>
                    <div>
                    ...
                    <div>
                        ...
                        <div style={{ display: "flex" }}>
                            <div style={{ display: "flex", alignItems: "center" }}>
                                ...
                                <img src={COIN} alt="coin" style={{ position: "absolute", top: "28.2pc", left: "7.7pc" }} />
                                <input type="text" style={{ width: "229px", color: "#fff", height: "52px", padding: "0 50px", flexDirection: "column", alignItems: "flex-start", margin: "-6px 20px", borderRadius: "6px", background: "rgba(15, 17, 26, 0.55)", }} />
                            ...
                            <div style={{ display: "flex" }}>
                                ...
                                <img src={SOL} alt="sol" style={{ position: "absolute", top: "28.1pc", left: "25.3pc", width: "20px", height: "20px" }} />

                                <input type="text" style={{ width: "229px", color: "#fff", height: "52px", padding: "0px 50px", flexDirection: "column", alignItems: "flex-start", margin: "-6px 20px", borderRadius: "6px", background: "rgba(15, 17, 26, 0.55)", }} />

                                {/* button sec=================== */}

                                <div style={{ display: "inline-flex", padding: "18px 30px", margin: "-5px 0", height: "50px", borderRadius: "8px", background: "#86F454", boxShadow: "0px 0px 10px 0px rgba(118, 255, 25, 0.40)", textAlign: "center", textTransform: "uppercase" }}>
