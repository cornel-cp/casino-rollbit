...
import MessagesHome from "../MainHome/MessagesHome";
...
const Home = () => {
    ...
    const System = () => {
        return (
            <>
                <div onClick={() => setshowM(false)} style={{ position: 'fixed', top: '0', right: '0', left: '0', bottom: '0', backgroundColor: '#000000aa' }}>
                </div>
                <div style={{ justifyContent: 'space-between', position: 'fixed', flexDirection: 'row', display: 'flex', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: '#1A1D29', height: '41.5pc', width: '55pc', borderRadius: '10px' }}>
                    ...
                    <div style={{}}>
                        <img src={Logo} style={{ position: 'absolute', top: '50px', right: "9pc" }} alt="profile" />
    ...
    return (
        ...
        <div style={{ background: "#1A1D29", height: "3200px" }}>
            {/* app bar */}
            <div className="h-16 flex justify-between items-cente p-3" style={{ boxShadow: "2px 2px 2px rgba(0,0,0,0.3)", position: 'sticky', top: "0", left: "0", right: "0", background: "#1A1D29" }}>
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <button onClick={() => openLoginModal()} className="text-white w-11 text-sm font-normal leading-5 tracking-wider mr-5">LOGIN</button>
                    ...
                    <div class="flex">
                        ...
                        {
                            isChatBox === false ?
                                <img onClick={() => setisChatBox(true)} src={MESSAGE_ICON} alt="message" class="mr-5" style={{ cursor: "pointer" }} />
                                :
                                null
                        }
                            ...
                            <div>
                                ...
                                <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", }}>
                                    ...
                                    <div style={{ display: "flex", gap: "4px", marginLeft: "2.5pc" }}>
                                        ...
                                        <img onClick={() => setisChatBox(false)} src={CROSS} alt="cross" style={{ width: "22px", height: "22px", flexShrink: "0", cursor: "pointer" }} />
                                    </div>
