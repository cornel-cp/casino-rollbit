...
const LoginSetting = () => {
  ...
  return (
    <>
      <div style={{ width: "1920px", height: "1203px", background: "#1A1D29", }}>


        <div style={{ width: "1915px", height: "65px", flexShrink: "0", background: "#1A1D29", boxShadow: "2px 2px 2px rgba(0,0,0,0.3)", position: "sticky", left: "0", top: "0" }}>
