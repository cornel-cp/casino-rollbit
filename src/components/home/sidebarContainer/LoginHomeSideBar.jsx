...
const LoginHomeSideBar = () => {
    return (
        ...
        <>
                ...
                <StyledComponent  className="w-64 flex flex-col flex-shrink-0 bg-gray-800 mr-14 overFlow">
                    ...
                    <div className="w-38 flex justify-between items-center ">
                        ...
                        <img src={ARROW_ICON} alt='arrow' style={{ marginRight: "30px" }} />
...
export default LoginHomeSideBar;